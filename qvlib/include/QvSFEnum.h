...
class QvSFEnum : public QvSField {
  public:
    ...
    QvBool findEnumName(int val, QvName& name) const;
};
...
#define QV_NODE_SET_SF_ENUM_TYPE(fieldName, enumType)                                                                  \
    do {                                                                                                               \
        ...
        fieldData->getEnumData(QV__QUOTE(enumType), _so_sf_enum_num, _so_sf_enum_vals, _so_sf_enum_names);             \
        fieldName.setEnums(_so_sf_enum_num, _so_sf_enum_vals, _so_sf_enum_names);                                      \
    } while (0)
