...
QvBool QvSFBitMask::readValue(QvInput* in) {
    char c;
    QvName n;
    int v;
...
#ifdef DEBUG
    if (enumValues == NULL) {
        QvDebugError::post("QvSFBitMask::readValue", "Enum values were never initialized");
