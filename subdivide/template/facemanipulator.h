...
template <class Mesh> class FaceManipulatorTp {
  public:
...
template <class Mesh> bool FaceManipulatorTp<Mesh>::toggleEdge(EnoType e) {
    typedef typename Mesh::FaceType FaceType;
...
template <class Mesh> bool FaceManipulatorTp<Mesh>::toggleVertex(EnoType e) {
    typedef typename Mesh::FaceType FaceType;
    bool res = false;
    assert(f->isToplevel());
...
template <class Mesh> bool FaceManipulatorTp<Mesh>::toggleSector(EnoType e) {
    typedef typename Mesh::FaceType FaceType;
...
template <class Mesh> void FaceManipulatorTp<Mesh>::fixVertexToggle(EnoType e) {
    typedef typename Mesh::FaceType FaceType;
    typedef typename Mesh::TLFaceType TLFaceType;
