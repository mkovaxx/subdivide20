...
static TagFlatMesh::FlatSectorType convertToFlatSector(QvUnknownNode* n) {
...
static QvUnknownNode* convertFromFlatSector(TagFlatMesh::FlatSectorType fs) {
